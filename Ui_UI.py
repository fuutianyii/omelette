...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Stacked.setStyleSheet("border:0px;padding:0px")
        self.Stacked.setObjectName("Stacked")
        self.hello_page = QtWidgets.QWidget()
        self.hello_page.setEnabled(True)
        self.hello_page.setStyleSheet("border:0px;padding:0px")
        ...
        self.homepage_right.setMinimumSize(QtCore.QSize(400, 0))
