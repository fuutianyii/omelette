...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.leftframe_top.setMinimumSize(QtCore.QSize(80, 0))
        ...
        self.left_first_button.setMinimumSize(QtCore.QSize(80, 80))
        self.left_first_button.setText("")
        self.left_first_button.setIconSize(QtCore.QSize(60, 60))
        ...
        self.left_third_button.setMinimumSize(QtCore.QSize(80, 80))
        self.left_third_button.setText("")
        self.left_third_button.setIconSize(QtCore.QSize(60, 60))
        ...
        self.left_forth_button.setMinimumSize(QtCore.QSize(80, 80))
        self.left_forth_button.setStyleSheet("")
        self.left_forth_button.setText("")
        self.left_forth_button.setIconSize(QtCore.QSize(60, 60))
...
"}")
        ...
        self.filter_list_comboBox.setMinimumSize(QtCore.QSize(160, 50))
        self.filter_list_comboBox.setMaximumSize(QtCore.QSize(160, 50))
        ...
        self.filter_date_comboBox.setMinimumSize(QtCore.QSize(160, 50))
        self.filter_date_comboBox.setMaximumSize(QtCore.QSize(160, 50))
        ...
        self.more_functions.setMinimumSize(QtCore.QSize(45, 45))
        self.more_functions.setMaximumSize(QtCore.QSize(45, 45))
        ...
        self.Sync.setMinimumSize(QtCore.QSize(45, 45))
        self.Sync.setMaximumSize(QtCore.QSize(45, 45))
        self.Sync.setText("")
        ...
        self.search_edit.setMinimumSize(QtCore.QSize(140, 45))
        self.search_edit.setMaximumSize(QtCore.QSize(400, 45))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setBold(False)
        font.setWeight(50)
        ...
        self.start_exam.setText("")
        self.start_exam.setIconSize(QtCore.QSize(25, 25))
        ...
        self.search_forget_words.setText("")
        self.search_forget_words.setIconSize(QtCore.QSize(25, 25))
        ...
        self.update_table.setMinimumSize(QtCore.QSize(200, 0))
        self.update_table.setMaximumSize(QtCore.QSize(200, 16777215))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 974, 542))
        ...
        self.reset_forget_button.setMaximumSize(QtCore.QSize(400, 60))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.reset_forget_button.setFont(font)
        ...
        self.review_Forgotten_button.setMaximumSize(QtCore.QSize(400, 60))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.review_Forgotten_button.setFont(font)
        ...
        self.radom_exam_button.setMaximumSize(QtCore.QSize(400, 60))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.radom_exam_button.setFont(font)
        ...
        self.exam_today_button.setMaximumSize(QtCore.QSize(400, 60))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.exam_today_button.setFont(font)
        ...
        self.review_words_button.setMaximumSize(QtCore.QSize(400, 60))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.review_words_button.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(20)
        self.checkBox_random.setFont(font)
        ...
        spacerItem5 = QtWidgets.QSpacerItem(611, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        spacerItem6 = QtWidgets.QSpacerItem(30, 20, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
